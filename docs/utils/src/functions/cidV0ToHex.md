...
> **cidV0ToHex**(`cidV0`): `` `0x${string}` ``

Defined in: [packages/utils/src/cid.ts:25](https://github.com/aboutcircles/sdk-v2/blob/71cffbae585b19dfb4a8e752b25f9afcf9e11b66/packages/utils/src/cid.ts#L25)
